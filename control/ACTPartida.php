...
class ACTPartida extends ACTbase{
	...
	function listarPartidaRecurso(){
		...
		if($this->objParam->getParametro('tipo')!=''){
			...
			if($this->objParam->getParametro('tipo') == 'ingreso_egreso'){
				$this->objParam->addFiltro("par.tipo in (''recurso'')");
			}
			else{
				$this->objParam->addFiltro("par.tipo = ''".$this->objParam->getParametro('tipo')."''");
			}
		...
		if($this->objParam->getParametro('tipoReporte')=='excel_grid' || $this->objParam->getParametro('tipoReporte')=='pdf_grid'){
			$this->objReporte = new Reporte($this->objParam, $this);
			$this->res = $this->objReporte->generarReporteListado('MODPartida','listarPartidaRecurso');
		} else{
			$this->objFunc=$this->create('MODPartida');
			$this->res=$this->objFunc->listarPartidaRecurso();
		}
