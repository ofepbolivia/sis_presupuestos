...
class ACTPresupPartida extends ACTbase{
    ...
    function reporteEjecucion(){
				...
				if($this->objParam->getParametro('formato_reporte')=='pdf'){
						if($this->objParam->getParametro('tipo_reporte') == 'resumen_categoria' || $this->objParam->getParametro('tipo_reporte') =='resumen_unidad_ejecutora') {
								$reporte = new REjecucionCategoria($this->objParam);
						}else{
					...
					if($this->objParam->getParametro('tipo_reporte') == 'resumen_categoria' || $this->objParam->getParametro('tipo_reporte') =='resumen_unidad_ejecutora') {
							$reporte = new REjecucionCategoriaXls($this->objParam);
					}else{
