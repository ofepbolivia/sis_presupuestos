...
class MODObjetivo extends MODbase
{
    ...
    function obtenerAccionesMedianoPlazo()
    {
        $this->procedimiento = 'pre.ft_objetivo_sel';
        $this->setCount(false);
        $this->transaccion = 'PRE_OBJ_AMP_SEL';
        $this->tipo_procedimiento = 'SEL';
        ...
        $this->captura('periodo_ejecucion', 'varchar');
        $this->captura('producto', 'varchar');
        $this->captura('id_objetivo', 'integer');
    ...
    function obtenerAccionesCortoPlazo()
    {
        $this->procedimiento = 'pre.ft_objetivo_sel';
        $this->setCount(false);
        $this->transaccion = 'PRE_OBJ_ACP_SEL';
        $this->tipo_procedimiento = 'SEL';
    ...
    function obtenerAccionesCortoPlazoCAMP()
    {
        $this->procedimiento = 'pre.ft_objetivo_sel';
        $this->setCount(false);
        $this->transaccion = 'PRE_OBJ_ACP_CAMP';
        $this->tipo_procedimiento = 'SEL';

        $this->setParametro('id_gestion', 'id_gestion', 'integer');

        $this->captura('codigo_amp', 'varchar');
        $this->captura('descripcion_amp', 'varchar');
        $this->captura('producto_amp', 'varchar');
        $this->captura('codigo_acp', 'varchar');
        $this->captura('descripcion_acp', 'varchar');
        $this->captura('producto_acp', 'varchar');
    ...
    function articulacionPoa()
    {
        ...
        $this->captura('descripcion_acp', 'varchar');
        $this->captura('producto_acp', 'varchar');
        $this->captura('operaciones', 'text');
        $this->captura('actividades', 'text');
        $this->captura('centro_costo', 'text');
        $this->captura('estrucutra_programatica', 'text');
    ...
    function listarObjetivoArbD()
    {
        //Definicion de variables para ejecucion del procedimientp
        $this->procedimiento = 'pre.ft_objetivo_sel';
        $this->setCount(false);
        $this->transaccion = 'PRE_OBJ_ARB_SELD';
        $this->tipo_procedimiento = 'SEL';//tipo de transaccion
