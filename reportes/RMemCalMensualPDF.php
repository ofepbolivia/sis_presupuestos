...
class RMemCalMensualPDF extends  ReportePDF {
    var $datos_titulo;
    var $datos_detalle;
    var $ancho_hoja;
    var $gerencia;
    ...
    function Header() {
        ...
        $this->Cell(0,5,"PRESUPUESTO GESTION ".$this->datos_detalle[0]["gestion"],0,1,'C'); //fRnk: se quitó ANTEPROYECTO HR00569
        //$this->Ln();
        $this->SetFont('','B',7);
        ...
        $conf_par_tablewidths=array(10,30,50,80,15,20,15,10,10,25);
        $conf_par_tablealigns=array('C','C','J','C','C','C','C','C','C','C');
        ...
        $this->Cell(15,3,"ABR","LT",0,'C');
        $this->Cell(15,3,"MAY","LT",0,'C');
        $this->Cell(15,3,"JUN","LT",0,'C');
        $this->Cell(15,3,"JUL","LT",0,'C');
        $this->Cell(15,3,"AGO","LT",0,'C');
        $this->Cell(15,3,"SEP","LT",0,'C');
        $this->Cell(15,3,"OCT","LT",0,'C');
        $this->Cell(15,3,"NOV","LT",0,'C');
        $this->Cell(15,3,"DIC","LT",0,'C');
        $this->Cell(25,3,"TOTAL","LTR",1,'C');

        $this->Cell(10,3,"","LB",0,'C');
        $this->Cell(35,3,"","LB",0,'C');
    ...
    function imprimirLinea($val,$count,$fill){
        ...
        //Obtenemos importe por periodo
        $importeXperiodo = explode(',',$val['importe_periodo']);
    ...
    function imprimirPartida($titulo,$fill){
        ...
        $this->SetFont('','B',9);
        $this->tablewidths=array(10+50+50+80+15+20+15+25+145);
    ...
    function imprimirConcepto($titulo,$fill){
        $conf_par_tablewidths=array(10+50+50+80+15+20+15+25+145);
