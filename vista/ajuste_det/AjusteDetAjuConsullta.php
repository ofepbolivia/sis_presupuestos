...
?>
<script>
    Phx.vista.AjusteDetAjuConsullta = {
        bedit: false,
        bnew: false,
        bsave: false,
        bdel: false,
        ...
        title: 'Incrementos',
        nombreVista: 'AjusteDetAjuConsullta',

        constructor: function(config) {
            Phx.vista.AjusteDetAjuConsullta.superclass.constructor.call(this,config);
            this.init();
        ...
        loadValoresIniciales:function(){
            Phx.vista.AjusteDetAjuConsullta.superclass.loadValoresIniciales.call(this);
