...
/**
 *@package pXP
 *@file    FormDetalleSubirFormulacionAdmin.php
...
?>
<script>
    Phx.vista.FormDetalleSubirFormulacionAdmin=Ext.extend(Phx.frmInterfaz,{

            constructor:function(config)
            {
                Ext.apply(this,config);
                Phx.vista.FormDetalleSubirFormulacionAdmin.superclass.constructor.call(this,config);
                this.init();
            ...
            {
                //Phx.vista.FormDetalleSubirFormulacionAdmin.superclass.loadValoresIniciales.call(this);
