...
<script>
    Phx.vista.EntidadTransferencia = Ext.extend(Phx.gridInterfaz, {
        ...
        constructor: function (config) {
            ...
            /**
             this.addButton('clonarConf',{
                text: 'Clonar configuración',
                iconCls: 'blist',
                disabled: false,
                handler: this.clonarConf,
                tooltip: 'Clonar la configuración para la siguiente gestión'
            });
             */
            this.addButton('clonarConf', {
                //grupo: [0, 1, 2, 3, 4, 5],
        ...
        clonarEntidad: function () {
            /*rec = {data: {id_gestion: this.cmbGestion.getValue()}}
            Phx.CP.loadWindows('/../../../sis_presupuestos/vista/entidad_tranferencia/ClonarEntidad.php',
                'Definir la gestión a la que desea duplicar esta Entidad',
                {
                    modal: true,
                    width: 450,
                    height: 150
