    ...
    Phx.vista.Objetivo = Ext.extend(Phx.arbGridInterfaz, {
            ...
            constructor: function (config) {
                ...
                this.addButton('exp_menu', {
                    ...
                    iconCls: 'bexport',
                    disabled: false,
                    tooltip: '<b>Permite exportar el organigrama</b>',
                    menu: {
                        items: [
                            {
                                ...
                                text: 'PDF Horizontal', handler: this.expReport, scope: this, argument: {tipo: 'pdf-h'}
                            }
                        ]
                    }
                });
            ...
            expReport: function (resp) {
                //Adalid: reportes HR 2024-01273
                if (this.cmbGestion.getValue()) {
                    Phx.CP.loadingShow();
                    Ext.Ajax.request({
                        url: '../../sis_presupuestos/control/Objetivo/generarReportes',
                        params: {tipo: resp.argument.tipo, id_gestion: this.cmbGestion.getValue()},
            ...
            onButtonNew: function () {
                if (this.cmbGestion.getValue()) {
                    ...
                    var cmpDigito = this.getComponente('digito');

                    // AQUI pones el nombre correcto del atributo
                    var valorCodigo = nodo ? nodo.attributes.digito : null;

                    console.log('Valor en nodo.attributes.codigo = ', valorCodigo);

                    if (cmpDigito && valorCodigo) {
                        cmpDigito.setValue(valorCodigo);
                    }
            ...
            onButtonEdit: function () {
                Phx.vista.Objetivo.superclass.onButtonEdit.call(this);
                ...
                console.log('Valor en nodo.attributes.codigo Editar = ', valorCodigo);
